...
const AlbumCard = (props: any) => {
  return (
    <div className="group w-52 h-fit  bg-[#444141]/40 hover:bg-[#444141]/70 pt-[0.70rem] pb-8 flex flex-col items-center rounded-lg shadow-xl animate-fade-in-up">
      <div className="relative">
        <img
          src={props?.item?.image}
          alt={props?.item?.name}
          className="h-40 w-44 rounded-md drop-shadow-[0_5px_10px_#1a1515]"
        />
